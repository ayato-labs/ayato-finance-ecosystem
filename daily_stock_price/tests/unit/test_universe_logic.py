...
def test_us_universe_fallback_no_key(temp_data_dir):
    ...
    with patch("requests.get") as mock_get:
        mock_resp = MagicMock()
        mock_resp.text = "<table><tr><th>Symbol</th><th>Security</th></tr><tr><td>AAPL</td><td>Apple</td></tr></table>"
...
def test_us_universe_fmp_failure_fallback(temp_data_dir):
    ...
    with patch("requests.get") as mock_get:
        ...
        mock_resp_wiki.text = "<table><tr><th>Symbol</th><th>Security</th></tr><tr><td>GOOG</td><td>Google</td></tr></table>"
