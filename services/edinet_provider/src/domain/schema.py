...
from src.domain.contracts import CompanyFact, DataContract, FilingMetadata, NarrativeBlock
...
TABLE_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "narr_db": {
        ...
        "tables": {
            "narratives": {
                "description": "Extracted text blocks (Business Risks, etc.) using ZSTD",
