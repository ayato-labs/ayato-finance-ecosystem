...
def test_engine_batch_partial_success(tmp_path, monkeypatch):
    ...
    results = [
        {
            "metadata": {
                "doc_id": "GOOD_1", "edinet_code": "E1", "sec_code": "T1",
                "filer_name": "F1", "doc_description": "D1", "submit_datetime": "2024-01-01",
                "form_code": "C1", "doc_type_code": "T1", "session_id": "S1"
            },
            "narratives": [], "facts": []
        },
        {
            "metadata": {
                "doc_id": None, "edinet_code": "E2", "sec_code": "T2", # This will fail on INSERT
                "filer_name": "F2", "doc_description": "D2", "submit_datetime": "2024-01-01",
                "form_code": "C2", "doc_type_code": "T2", "session_id": "S2"
            },
            "narratives": [], "facts": []
        },
        {
            "metadata": {
                "doc_id": "GOOD_2", "edinet_code": "E3", "sec_code": "T3",
                "filer_name": "F3", "doc_description": "D3", "submit_datetime": "2024-01-01",
                "form_code": "C3", "doc_type_code": "T3", "session_id": "S3"
            },
            "narratives": [], "facts": []
        }
    ]
