...
TABLE_SCHEMAS = {
    ...
    "daily_prices": {
        "description": "Daily OHLCV data with optimized fixed-point storage.",
        "version": 2,
        "sql": """
            CREATE TABLE IF NOT EXISTS daily_prices (
                ...
                Close DECIMAL(12, 1),
                Volume BIGINT,
                AdjustmentOpen DECIMAL(12, 1),
                AdjustmentHigh DECIMAL(12, 1),
                AdjustmentLow DECIMAL(12, 1),
                AdjustmentClose DECIMAL(12, 1),
