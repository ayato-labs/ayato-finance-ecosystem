...
try:
    ...
    try:
        ...
        conn.execute(
            "INSERT OR REPLACE INTO company_facts (ticker, cik, accession_number, form, filed_date, fiscal_year, fiscal_period, label, value, unit, is_standardized, raw_tag, session_id, ingested_at) SELECT *, CURRENT_TIMESTAMP FROM df"
        )
