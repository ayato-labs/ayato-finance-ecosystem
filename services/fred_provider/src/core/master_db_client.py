...
class MasterDBClient:
    def __init__(self):
        ...
        self.master_db_path = Path(
            "C:/Users/saiha/My_Service/programing/finance/services/master_db/data/master.duckdb"
        )
    ...
    def register_provider(self, provider_id: str, db_path: str, version: str, record_count: int):
        ...
        conn.execute(
            ...
            (provider_id, db_path, version, last_sync_timestamp, record_count)
            VALUES (?, ?, ?, ?, ?)
        """,
