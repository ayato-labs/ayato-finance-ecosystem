...
This directory contains records of significant architectural decisions made in the Finance Services workspace.

## Index

| ID | Title | Date | Status |
|----|-------|------|--------|
| [ADR-0001](ADR-0001-structured-logging.md) | Standardized Structured Logging with Loguru | 2026-05-26 | Accepted |
| [ADR-0002](ADR-0002-ruff-linting-standards.md) | Standardized Static Analysis with Ruff | 2026-05-26 | Accepted |
