...
def test_reconciler_delta_detection(mock_dbs):
    ...
    with duckdb.connect(mock_dbs["jp"]) as conn:
        conn.execute("INSERT INTO filings VALUES ('JP-PENDING', '7203', 'E02144', '120', '2026-05-01', '{}', '{}', CURRENT_TIMESTAMP)")
        conn.execute("INSERT INTO filings VALUES ('JP-DONE', '9984', 'E02777', '120', '2026-05-01', '{}', '{}', CURRENT_TIMESTAMP)")
        conn.execute("INSERT INTO structured_data VALUES ('JP-DONE', '9984', '{}', CURRENT_TIMESTAMP)")
        
    with duckdb.connect(mock_dbs["us"]) as conn:
        conn.execute("INSERT INTO filings VALUES ('US-PENDING', 'AAPL', '320193', '10-Q', '2026-05-01', '{}', '{}', CURRENT_TIMESTAMP)")
